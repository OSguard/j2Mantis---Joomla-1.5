...
<tr>
	...
	<td>
		<a href="?option=com_j2mantis&amp;view=showbug&amp;bugid=<?php echo urlencode(base64_encode($this->mantis->encode((string)$bug->id))); ?>&amp;Itemid=<?php echo JRequest::getInt('Itemid',0);?>"><?php echo $bug->summary ?></a>
	</td>
	<td>
